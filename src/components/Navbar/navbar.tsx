...
const Navbar = () => {
  return (
    <div className='flex justify-between mt-8'>
        <div className=' px-4 border border-b-4 border-l-4 rounded-md border-customYellow p-2 w-fit ml-5 cursor-pointer mb-6 transition-all duration-300 hover:bg-customYellow hover:text-black font-bold'>
